                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:18px;overflow:hidden;">
                    <tr>
                        <td style="background:#0b70ff;color:#ffffff;padding:26px 30px;">
                            ...
                            <h1 style="font-size:34px;line-height:1.05;margin:24px 0 10px;font-weight:500;">Your eSIM is ready to install</h1>
                            <p style="font-size:15px;line-height:1.6;margin:0;">Thanks for choosing BlipBlap. Your travel data plan is ready. Scan the QR code below and follow the steps to connect.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:30px;">
                            ...
                            <div style="border-top:1px solid #e8edf1;margin:28px 0 0;padding-top:24px;">
                                ...
                                <ol style="margin:0;padding-left:22px;color:#152238;font-size:15px;line-height:1.7;">
                                    <li>Connect your phone to Wi-Fi before installing.</li>
                                    <li>Open your phone camera or go to cellular/mobile data settings and choose add eSIM.</li>
                                    <li>Scan the QR code in this email.</li>
                                    <li>Follow the phone prompts, then name the line BlipBlap if asked.</li>
                                    <li>When you reach your destination, turn on this eSIM for mobile data and enable data roaming for the BlipBlap line.</li>
                                </ol>
                            </div>

                            <div style="background:#eef6fb;border-radius:14px;margin-top:24px;padding:18px;">
                                <h3 style="color:#0b70ff;font-size:18px;margin:0 0 12px;">Manual install details</h3>
                                <p style="color:#6f7782;font-size:13px;line-height:1.5;margin:0 0 14px;">Use these only if your phone asks for manual eSIM setup instead of QR scanning.</p>
                            ...
                            <p style="color:#6f7782;font-size:13px;line-height:1.6;margin:24px 0 0;">Keep this email safe until your trip is complete. If installation is interrupted, open your BlipBlap account and check the same install details there.</p>
                        </td>
                    </tr>
                </table>
            </td>
